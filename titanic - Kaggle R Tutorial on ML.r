...
# all_data is dataframe with passenger data
...
my_forest <- randomForest(as.factor(Survived) ~ Pclass + Sex + Age + SibSp + Parch + Fare + Embarked + Title, train, ntree=1000, importance = TRUE)
